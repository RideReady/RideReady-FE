...
if (environment === 'development') {
  ...
  cspContent = `default-src 'self'; script-src 'self' https://www.ridereadybike.com 'sha256-WjvV57CIhmLZyoSLYrfd3e+xHWTmqUKA4z7SJ8eHXIQ='; img-src 'self' https://www.ridereadybike.com; connect-src 'self' https://www.ridereadybike.com http://www.strava.com ; ${fontStylesCSP}`;
}
