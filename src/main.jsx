...
if (environment === 'development') {
  ...
  cspContent = `default-src 'self'; script-src 'self' https://www.ridereadybike.com; img-src 'self' https://www.ridereadybike.com; connect-src 'self' https://www.ridereadybike.com http://www.strava.com ; ${fontStylesCSP}`;
}
