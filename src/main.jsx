...
if (environment === 'development') {
  ...
  cspContent = `default-src 'self'; script-src 'self' https://www.ridereadybike.com ; img-src 'self' https://www.ridereadybike.com; connect-src 'self' https://www.ridereadybike.com http://www.strava.com https://vercel.live/; frame-src https://vercel.live/ ; font-src 'self' https://fonts.gstatic.com/; style-src 'self' https://fonts.gstatic.com/;`;
}
